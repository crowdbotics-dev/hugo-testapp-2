"""
Django settings for hugo_testapp_2 project.
...
ROOT_URLCONF = 'hugo_testapp_2.urls'
...
WSGI_APPLICATION = 'hugo_testapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hugo_testapp_2 API",
    "DESCRIPTION": "API documentation for hugo_testapp_2 App",
    "VERSION": "v1",
}
